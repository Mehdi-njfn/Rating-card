        ...
        <>
            ...
            <div className="card">
                <div className="container ">
                    <div className="row">
                        <div id="star"><svg width="17" height="16" xmlns="http://www.w3.org/2000/svg"><path d="m9.067.43 1.99 4.031c.112.228.33.386.58.422l4.45.647a.772.772 0 0 1 .427 1.316l-3.22 3.138a.773.773 0 0 0-.222.683l.76 4.431a.772.772 0 0 1-1.12.813l-3.98-2.092a.773.773 0 0 0-.718 0l-3.98 2.092a.772.772 0 0 1-1.119-.813l.76-4.431a.77.77 0 0 0-.222-.683L.233 6.846A.772.772 0 0 1 .661 5.53l4.449-.647a.772.772 0 0 0 .58-.422L7.68.43a.774.774 0 0 1 1.387 0Z" fill="#FC7614"/></svg></div>
                    </div>
                    <div className="row mt-3">
                        <p className="title">{data[count].title}</p>
                    </div>
                    <div className="row">
                        <p id="text">{data[count].text}</p>
                    </div>
                    <div className="circle mt-3">
                        <button onClick={()=>setCount(count=0)} id="circle1" className="">1</button>
                        <button onClick={()=>setCount(count=1)} id="circle" className="mx-2">2</button>
                        <button onClick={()=>setCount(count=2)} id="circle" className="mx-2">3</button>
                        <button onClick={()=>setCount(count=3)} id="circle" className="mx-2">4</button>
                        <button onClick={()=>setCount(count=4)} id="circle" className="mx-2">5</button>
                    </div>
            ...
            <div>
                <div className="card xxyy">
                    <div className="container">
                        ...
                        <div className="mt-2">
                            <p id="tnk">We appreclate you taking the time to give a rating. If you ever need more support, don't hesitate to get in touch!</p>
                        </div>
                    </div>
                </div>
            </div>}
